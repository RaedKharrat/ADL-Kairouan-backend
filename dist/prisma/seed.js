...
async function main() {
    ...
    const settings = [
        { key: 'site_name', value: 'ADL Kairouan', group: client_1.SettingGroup.GENERAL, label: 'Site Name' },
        { key: 'site_tagline', value: 'Association de Développement Local', group: client_1.SettingGroup.GENERAL, label: 'Site Tagline' },
        { key: 'site_description', value: 'Une plateforme institutionnelle dédiée au développement local et à la transparence.', group: client_1.SettingGroup.GENERAL, label: 'Site Description' },
        { key: 'contact_email', value: 'contact@adlkairouan.tn', group: client_1.SettingGroup.CONTACT, label: 'Contact Email' },
        { key: 'contact_phone_tn', value: '+216 55 566 536', group: client_1.SettingGroup.CONTACT, label: 'Phone Tunisia' },
        { key: 'contact_phone_ca', value: '+1 514 712 1919', group: client_1.SettingGroup.CONTACT, label: 'Phone Canada' },
        { key: 'contact_address', value: 'Kairouan, Tunisie', group: client_1.SettingGroup.CONTACT, label: 'Address' },
        { key: 'social_facebook', value: 'https://facebook.com/adlkairouan', group: client_1.SettingGroup.SOCIAL, label: 'Facebook' },
        { key: 'social_twitter', value: 'https://twitter.com/adlkairouan', group: client_1.SettingGroup.SOCIAL, label: 'Twitter/X' },
        { key: 'social_linkedin', value: 'https://linkedin.com/company/adlkairouan', group: client_1.SettingGroup.SOCIAL, label: 'LinkedIn' },
        { key: 'social_youtube', value: 'https://youtube.com/@adlkairouan', group: client_1.SettingGroup.SOCIAL, label: 'YouTube' },
        { key: 'seo_title', value: 'ADL Kairouan — Association de Développement Local', group: client_1.SettingGroup.SEO, label: 'Default SEO Title' },
        { key: 'seo_description', value: 'ADL Kairouan œuvre pour le développement local, la transparence et la bonne gouvernance.', group: client_1.SettingGroup.SEO, label: 'Default SEO Description' },
        { key: 'footer_text', value: '© 2025 ADL Kairouan. Tous droits réservés.', group: client_1.SettingGroup.GENERAL, label: 'Footer Text' },
    ];
