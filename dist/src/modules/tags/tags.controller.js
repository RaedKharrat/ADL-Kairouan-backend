...
let TagsController = class TagsController {
    ...
    findOne(id) { return this.tagsService.findOne(id); }
    create(body) { return this.tagsService.create(body); }
    update(id, body) { return this.tagsService.update(id, body); }
    remove(id) { return this.tagsService.remove(id); }
};
