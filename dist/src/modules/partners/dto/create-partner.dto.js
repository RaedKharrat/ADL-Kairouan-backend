...
class CreatePartnerDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, logo: { required: true, type: () => String }, website: { required: false, type: () => String }, order: { required: false, type: () => Number }, isActive: { required: false, type: () => Boolean } };
    }
}
