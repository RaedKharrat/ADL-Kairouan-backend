...
let ContactController = class ContactController {
    ...
    findAll(query) { return this.contactService.findAll(query); }
    getStats() { return this.contactService.getStats(); }
    findOne(id) { return this.contactService.findOne(id); }
    markRead(id) { return this.contactService.markRead(id); }
    archive(id) { return this.contactService.archive(id); }
    remove(id) { return this.contactService.remove(id); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ContactController.prototype, "archive", null);
__decorate([
