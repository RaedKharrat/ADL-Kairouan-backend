...
class CreateContactMessageDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 100 }, email: { required: true, type: () => String }, phone: { required: false, type: () => String }, subject: { required: false, type: () => String, maxLength: 200 }, message: { required: true, type: () => String, maxLength: 2000 } };
    }
}
