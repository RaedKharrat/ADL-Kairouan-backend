...
export class CreateBlogPostDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsArray() gallery?: string[];
  @ApiPropertyOptional() @IsOptional() @IsArray() pdfFiles?: string[];
